...
export interface VestingWalletReferralUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "FACTORY_ROLE"
...
export interface VestingWalletReferralUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): VestingWalletReferralUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: VestingWalletReferralUpgradeableInterface;
