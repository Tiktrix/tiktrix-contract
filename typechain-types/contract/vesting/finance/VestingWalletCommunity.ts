...
export interface VestingWalletCommunityInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "FACTORY_ROLE"
...
export interface VestingWalletCommunity extends BaseContract {
  connect(runner?: ContractRunner | null): VestingWalletCommunity;
  waitForDeployment(): Promise<this>;

  interface: VestingWalletCommunityInterface;
