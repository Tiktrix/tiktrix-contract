...
export interface TrixTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface TrixToken extends BaseContract {
  connect(runner?: ContractRunner | null): TrixToken;
  waitForDeployment(): Promise<this>;

  interface: TrixTokenInterface;
